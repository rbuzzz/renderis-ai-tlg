...
BASE_RU: Dict[str, str] = {
    ...
    "payment_topup_wallet": "👛 Wallet Pay",
    ...
    "walletpay_choose": "👛 Выберите пакет для оплаты через Wallet Pay:",
    "walletpay_unavailable": "Wallet Pay сейчас недоступен. Проверьте настройки интеграции.",
    "walletpay_create_failed": "Не удалось создать счет Wallet Pay.",
    "walletpay_status_failed": "Не удалось проверить статус оплаты Wallet Pay.",
    "walletpay_invoice_created": "Счет создан: {amount} {currency}. Откройте оплату и после оплаты нажмите «Проверить оплату».",
    "walletpay_waiting": "Оплата еще не подтверждена. Статус: {status}.",
    "walletpay_canceled": "Счет не оплачен. Статус: {status}.",
    "walletpay_pay_button": "👛 Wallet Pay",
    "walletpay_check_button": "🔄 Проверить оплату",
...
BASE_EN: Dict[str, str] = {
    ...
    "walletpay_choose": "👛 Choose a package for Wallet Pay:",
    "walletpay_unavailable": "Wallet Pay is currently unavailable. Check integration settings.",
    "walletpay_create_failed": "Failed to create Wallet Pay invoice.",
    "walletpay_status_failed": "Failed to check Wallet Pay payment status.",
    "walletpay_invoice_created": "Invoice created: {amount} {currency}. Open payment and tap “Check payment” after payment.",
    "walletpay_waiting": "Payment is not confirmed yet. Status: {status}.",
    "walletpay_canceled": "Invoice is not paid. Status: {status}.",
    "walletpay_pay_button": "👛 Wallet Pay",
    "walletpay_check_button": "🔄 Check payment",
...
BASE_ES.update(
    {
        ...
        "walletpay_choose": "👛 Elige un paquete para pagar con Wallet Pay:",
        "walletpay_unavailable": "Wallet Pay no esta disponible ahora. Revisa la configuracion de integracion.",
        "walletpay_create_failed": "No se pudo crear la factura de Wallet Pay.",
        "walletpay_status_failed": "No se pudo verificar el estado del pago de Wallet Pay.",
        "walletpay_invoice_created": "Factura creada: {amount} {currency}. Abre el pago y pulsa «Verificar pago» despues de pagar.",
        "walletpay_waiting": "El pago aun no esta confirmado. Estado: {status}.",
        "walletpay_canceled": "La factura no esta pagada. Estado: {status}.",
        "walletpay_pay_button": "👛 Wallet Pay",
        "walletpay_check_button": "🔄 Verificar pago",
