...
BASE_RU: Dict[str, str] = {
    ...
    "output_empty_hint": "Ваши результаты появятся здесь ✨\nОпишите, что хотите создать, и нажмите «Сгенерировать».",
    "result_view_grid": "Сетка",
    "result_view_carousel": "Карусель",
    "result_download": "Скачать",
    "result_regenerate": "Повторить",
    "result_regenerate_this": "Повторить эту",
    "result_edit_prompt": "Изменить промпт",
    "result_edit_ai": "Редактировать с AI",
    "result_edit_with_title": "Редактировать с помощью:",
    "result_edit_with_no_models": "Нет моделей с референсами.",
    "result_favorite_add": "В избранное",
    "result_favorite_remove": "Убрать из избранного",
    "result_reference_added": "Изображение добавлено как референс. Обновите промпт и запустите генерацию.",
    "result_reference_limit": "Достигнут максимум референс-изображений.",
    "result_reference_failed": "Не удалось добавить изображение в референсы.",
    "result_favorite_saved": "Сохранено в избранное.",
    "result_favorite_removed": "Удалено из избранного.",
    "download": "Скачать",
    "delete": "Удалить",
    ...
    "topup_crypto_option": "🪙 Crypto Pay",
    "topup_modal_redeem_title": "Активация промо-кода",
    "topup_modal_crypto_title": "🪙 Crypto Pay",
    ...
    "prompt_helper_button": "Шаблоны",
    "prompt_helper_title": "Помощник промптов",
    "prompt_helper_empty": "Шаблоны пока недоступны.",
    "prompt_history_button": "История",
    "prompt_history_title": "Последние промпты",
    "prompt_history_empty": "История промптов пуста.",
    "prompt_history_remove": "Удалить из истории",
    "prompt_length_hint": "Символов: {count}/{max}",
    "prompt_too_long": "Промпт слишком длинный. Максимум: {max} символов.",
    "brain_improve_button": "Improve Prompt (стоимость: {cost})",
    "brain_improve_loading": "Enhancing your prompt...",
    "brain_restore_original": "↩ Вернуть исходный",
    "brain_improve_success": "Промпт улучшен.",
    "brain_unavailable": "AI Brain сейчас недоступен.",
    "brain_daily_limit_reached": "Дневной лимит улучшений достигнут.",
    "brain_not_enough_credits": "Недостаточно кредитов для улучшения промпта.",
    "brain_rate_limited": "Слишком часто. Попробуйте через пару секунд.",
    "brain_failed": "Не удалось улучшить промпт.",
    "brain_pack_used": "Использовано улучшение из пакета.",
    "brain_credits_used": "Списано {credits} кредитов за улучшение.",
    "brain_pack_buy_button": "Купить пакет: {size} улучшений за {price} кр.",
    "brain_pack_remaining": "В пакете: {count}",
    "brain_pack_buying": "Покупаем пакет улучшений...",
    "brain_pack_buy_success": "Пакет куплен: +{size} улучшений.",
    "brain_pack_buy_failed": "Не удалось купить пакет улучшений.",
    "prompt_template_logo_title": "Логотип / бренд-марк",
    "prompt_template_logo_text": "Логотип для [бренда], минималистичный вектор, чистые линии, фирменные цвета, прозрачный фон",
    "prompt_template_social_title": "Пост для соцсетей",
    "prompt_template_social_text": "Пост для соцсетей о [теме], смелая типографика, современный стиль, яркий акцент, формат 4:5",
    "prompt_template_cinematic_title": "Кинематографичная сцена",
    "prompt_template_cinematic_text": "Кинематографичная сцена с [объектом], драматичный свет, атмосферный туман, сверхдетализация, 4K",
    "prompt_template_product_title": "Product mockup",
    "prompt_template_product_text": "Реалистичный mockup продукта [название], студийный свет, мягкие тени, чистый фон, рекламный стиль",
    "prompt_template_icon_title": "Минималистичная иконка",
    "prompt_template_icon_text": "Минималистичная иконка для [приложения], плоский стиль, четкий контур, центрированная композиция, SVG look",
    "prompt_template_portrait_title": "Фотореалистичный портрет",
    "prompt_template_portrait_text": "Фотореалистичный портрет [человека], cinematic lighting, ultra detailed, 4K, professional photography",
    ...
    "miniapp_auth_in_progress": "Выполняем вход через Telegram Mini App...",
    "miniapp_auth_failed": "Не удалось автоматически войти. Откройте приложение снова из бота.",
    "prompt_required": "Промпт не может быть пустым.",
    "request_sent": "Запрос отправлен.",
    "error_prefix": "Ошибка",
    "promo_added": "Начислено",
    "promo_error": "Ошибка",
    "crypto_title": "🪙 Crypto Pay",
    ...
    "quote_cost": "Стоимость: {total} кредитов",
    "quote_info_title": "Детализация стоимости",
    "quote_info": "ℹ️",
    "quote_breakdown_base": "База",
    "quote_breakdown_outputs": "Выходы (x{count})",
    "quote_breakdown_discount": "Скидка",
    "quote_breakdown_total": "Итого",
    "quote_breakdown_fallback": "Детализация недоступна.",
    "quote_insufficient": "Недостаточно кредитов. Пополните баланс.",
    "confirm_title": "Подтверждение генерации",
    "confirm_message": "Эта генерация будет стоить {total} кредитов. Продолжить?",
    "confirm_cancel": "Отмена",
    "confirm_continue": "Подтвердить",
    "confirm_dont_show_again": "Не показывать больше",
    "confirm_skip_toggle": "Пропускать подтверждение перед генерацией",
    "quote_login_required": "Войдите, чтобы увидеть стоимость.",
    "quote_unavailable": "Не удалось рассчитать стоимость.",
    "gen_status_queued": "В очереди...",
    "gen_status_step_1": "Генерация (шаг 1/3)...",
    "gen_status_step_2": "Генерация (шаг 2/3)...",
    "gen_status_finalizing": "Финализация...",
    "gen_eta_format": "~{min}-{max} сек",
    "gen_cancel": "Отмена",
    "gen_canceled_local": "Отменено. Можно запустить новую генерацию.",
    "gen_running_already": "Генерация уже выполняется.",
    "gen_connection_retrying": "Соединение потеряно. Повторяем...",
    "gen_taking_long": "Дольше обычного. Подождите или попробуйте снова.",
    "gen_failed_basic": "Генерация не удалась.",
    "gen_partial_done": "Генерация завершена частично.",
    # Ratios / resolutions
    ...
    "confirm_improve_prompt": "✨ Improve Prompt",
    ...
    "result_slightly_change": "🎨 Слегка изменить",
    "result_remix": "🔀 Ремикс",
    "result_upscale": "⬆️ Апскейл",
    "result_finish": "❌ Завершить",
    "result_done": "✅ Завершено. Если хотите еще — нажмите /start.",
    "result_action_confirm": "✅ Подтвердить",
    "result_action_cancel": "❌ Отмена",
    "result_action_confirm_text": "Действие: {action}",
    "result_action_prompt_hint": "Промпт будет адаптирован автоматически.",
    "result_mode_variation": "Слегка изменить",
    "result_mode_remix": "Ремикс",
    "result_mode_upscale": "Апскейл",
    "brain_bot_use": "✅ Использовать",
    "brain_bot_restore": "↩ Вернуть исходный",
    "brain_bot_result_hint": "Улучшенный промпт:",
    "repeat_prompt": (
    ...
    "start_terms": "📜 Используя бот, вы подтверждаете соблюдение законов и <a href=\"https://rebrand.ly/8da8cc\">правил</a> сервиса.",
    "terms_intro": "Перед использованием бота необходимо подтвердить согласие с условиями:",
    "terms_link": "📄 <a href=\"{link}\">Прочитать условия</a>",
    "terms_question": "Вы согласны с условиями?",
    "terms_accept_btn": "✅ Согласен",
    "terms_decline_btn": "❌ Не согласен",
    "terms_read_btn": "📄 Прочитать условия",
    "terms_declined_blocked": "Доступ к боту заблокирован до принятия условий.",
    "terms_blocked_notice": "Пользование ботом невозможно без принятия условий.",
    "terms_blocked_alert": "Пользование ботом невозможно без принятия условий.",
    "start_bonus": (
    ...
    "history_timeline_title": "🕘 Таймлайн",
    "history_model": "🧠 Модель: {model}",
    "history_status": "📌 Статус: {status}",
    "history_cost": "💳 Стоимость: {cost} кр.",
    # Payments
    ...
    "payment_topup_crypto": "🪙 Купить через Crypto Pay",
    ...
    "settings_back_to_main": "🏠 Главное меню",
    "settings_lang_prompt": "Выберите язык интерфейса:",
    "settings_lang_prompt_first": "Выберите предпочтительный язык:",
    "settings_lang_saved": "Язык сохранен: {language}",
    ...
    "cryptopay_choose": "🪙 Выберите пакет для оплаты через Crypto Pay:",
    "cryptopay_unavailable": "Crypto Pay сейчас недоступен. Проверьте настройки интеграции.",
    "cryptopay_create_failed": "Не удалось создать счет Crypto Pay.",
    "cryptopay_status_failed": "Не удалось проверить статус оплаты Crypto Pay.",
    "cryptopay_invoice_created": "Счет создан: {amount} {currency}. Откройте оплату и после оплаты нажмите «Проверить оплату».",
    "cryptopay_waiting": "Оплата еще не подтверждена. Статус: {status}.",
    "cryptopay_canceled": "Счет не оплачен. Статус: {status}.",
    "cryptopay_pay_button": "🪙 Crypto Pay",
    "cryptopay_check_button": "🔄 Проверить оплату",
    "cryptopay_paid_notify": (
        "✅ Оплата через Crypto Pay подтверждена. Начислено {credits} "
        "{credits, plural, one {кредит} few {кредита} many {кредитов} other {кредита}}."
    ),
...
BASE_EN: Dict[str, str] = {
    ...
    "output_empty_hint": "Your results will appear here ✨\nDescribe what you want to create and press Run.",
    "result_view_grid": "Grid",
    "result_view_carousel": "Carousel",
    "result_download": "Download",
    "result_regenerate": "Regenerate",
    "result_regenerate_this": "Regenerate this",
    "result_edit_prompt": "Edit prompt",
    "result_edit_ai": "Edit with AI",
    "result_edit_with_title": "Edit with:",
    "result_edit_with_no_models": "No reference-capable models available.",
    "result_favorite_add": "Save to favorites",
    "result_favorite_remove": "Remove favorite",
    "result_reference_added": "Image added as reference. You can now modify your prompt and regenerate.",
    "result_reference_limit": "Maximum number of reference images reached.",
    "result_reference_failed": "Failed to add image as reference.",
    "result_favorite_saved": "Saved to favorites.",
    "result_favorite_removed": "Removed from favorites.",
    "download": "Download",
    "delete": "Delete",
    ...
    "prompt_helper_button": "Prompt Helper",
    "prompt_helper_title": "Prompt presets",
    "prompt_helper_empty": "No templates available.",
    "prompt_history_button": "History",
    "prompt_history_title": "Recent prompts",
    "prompt_history_empty": "Prompt history is empty.",
    "prompt_history_remove": "Remove from history",
    "prompt_length_hint": "Characters: {count}/{max}",
    "prompt_too_long": "Prompt is too long. Maximum: {max} characters.",
    "brain_improve_button": "Improve Prompt (cost: {cost})",
    "brain_improve_loading": "Enhancing your prompt...",
    "brain_restore_original": "↩ Restore original",
    "brain_improve_success": "Prompt improved.",
    "brain_unavailable": "AI Brain is currently unavailable.",
    "brain_daily_limit_reached": "Daily improvement limit reached.",
    "brain_not_enough_credits": "Not enough credits to improve prompt.",
    "brain_rate_limited": "Too many requests. Try again in a moment.",
    "brain_failed": "Failed to improve prompt.",
    "brain_pack_used": "Used one improvement from your pack.",
    "brain_credits_used": "Charged {credits} credits for improvement.",
    "brain_pack_buy_button": "Buy pack: {size} improves for {price} credits",
    "brain_pack_remaining": "In pack: {count}",
    "brain_pack_buying": "Buying improvement pack...",
    "brain_pack_buy_success": "Pack purchased: +{size} improvements.",
    "brain_pack_buy_failed": "Failed to buy improvement pack.",
    "prompt_template_logo_title": "Logo / Brand mark",
    "prompt_template_logo_text": "Logo or brand mark for [brand name], minimalist vector style, clean lines, bold contrast, transparent background",
    "prompt_template_social_title": "Social media post",
    "prompt_template_social_text": "Social media post about [topic], eye-catching composition, bold typography, vibrant accent colors, 4:5 layout",
    "prompt_template_cinematic_title": "Cinematic scene",
    "prompt_template_cinematic_text": "Cinematic scene with [subject], dramatic lighting, volumetric fog, ultra detailed, film still, 4K",
    "prompt_template_product_title": "Product mockup",
    "prompt_template_product_text": "Premium product mockup for [product], studio lighting, soft shadows, realistic materials, commercial style",
    "prompt_template_icon_title": "Minimal icon",
    "prompt_template_icon_text": "Minimal icon for [app idea], flat design, crisp edges, centered composition, vector look",
    "prompt_template_portrait_title": "Photorealistic portrait",
    "prompt_template_portrait_text": "Photorealistic portrait of [subject], cinematic lighting, ultra detailed, 4K, professional photography",
    ...
    "miniapp_auth_in_progress": "Signing in via Telegram Mini App...",
    "miniapp_auth_failed": "Automatic sign-in failed. Please reopen the app from the bot.",
    ...
    "quote_cost": "Cost: {total} credits",
    "quote_info_title": "Cost breakdown",
    "quote_info": "ℹ️",
    "quote_breakdown_base": "Base",
    "quote_breakdown_outputs": "Outputs (x{count})",
    "quote_breakdown_discount": "Discount",
    "quote_breakdown_total": "Total",
    "quote_breakdown_fallback": "Breakdown is unavailable.",
    "quote_insufficient": "Not enough credits. Please top up.",
    "confirm_title": "Generation confirmation",
    "confirm_message": "This generation will cost {total} credits. Continue?",
    "confirm_cancel": "Cancel",
    "confirm_continue": "Confirm",
    "confirm_dont_show_again": "Don't show again",
    "confirm_skip_toggle": "Skip confirmation before generation",
    "quote_login_required": "Login to see the cost.",
    "quote_unavailable": "Unable to calculate the cost.",
    "gen_status_queued": "Queued...",
    "gen_status_step_1": "Generating (step 1/3)...",
    "gen_status_step_2": "Generating (step 2/3)...",
    "gen_status_finalizing": "Finalizing...",
    "gen_eta_format": "~{min}-{max} sec",
    "gen_cancel": "Cancel",
    "gen_canceled_local": "Canceled. You can start a new generation.",
    "gen_running_already": "Generation is already running.",
    "gen_connection_retrying": "Connection lost. Retrying...",
    "gen_taking_long": "Taking longer than usual. Please wait or try again.",
    "gen_failed_basic": "Generation failed.",
    "gen_partial_done": "Generation completed with partial results.",
    ...
    "result_slightly_change": "🎨 Slightly change",
    "result_remix": "🔀 Remix",
    "result_upscale": "⬆️ Upscale",
    "result_finish": "❌ Finish",
    "result_done": "✅ Done. To create more, use /start.",
    "result_action_confirm": "✅ Confirm",
    "result_action_cancel": "❌ Cancel",
    "result_action_confirm_text": "Action: {action}",
    "result_action_prompt_hint": "Prompt will be adjusted automatically.",
    "result_mode_variation": "Slightly change",
    "result_mode_remix": "Remix",
    "result_mode_upscale": "Upscale",
    "brain_bot_use": "✅ Use this",
    "brain_bot_restore": "↩ Restore original",
    "brain_bot_result_hint": "Improved prompt:",
    "repeat_prompt": (
        "Repeat this request?\n"
    ...
    "terms_intro": "Before using the bot, you need to accept the following terms:",
    "terms_link": "📄 <a href=\"{link}\">Read terms</a>",
    "terms_question": "Do you agree with these terms?",
    "terms_accept_btn": "✅ I agree",
    "terms_decline_btn": "❌ I disagree",
    "terms_read_btn": "📄 Read terms",
    "terms_declined_blocked": "Access to the bot is blocked until you accept the terms.",
    "terms_blocked_notice": "Using the bot is impossible without accepting the terms.",
    "terms_blocked_alert": "Using the bot is impossible without accepting the terms.",
    ...
    "history_timeline_title": "🕘 Timeline",
    "history_model": "🧠 Model: {model}",
    "history_status": "📌 Status: {status}",
    "history_cost": "💳 Cost: {cost} cr.",
    ...
    "payment_topup_crypto": "🪙 Buy with Crypto Pay",
    ...
    "settings_back_to_main": "🏠 Main menu",
    "settings_lang_prompt": "Choose interface language:",
    "settings_lang_prompt_first": "Choose your preferred language:",
    "settings_lang_saved": "Language saved: {language}",
    ...
    "cryptopay_choose": "🪙 Choose a package for Crypto Pay:",
    "cryptopay_unavailable": "Crypto Pay is currently unavailable. Check integration settings.",
    "cryptopay_create_failed": "Failed to create Crypto Pay invoice.",
    "cryptopay_status_failed": "Failed to check Crypto Pay payment status.",
    "cryptopay_invoice_created": "Invoice created: {amount} {currency}. Open payment and tap “Check payment” after payment.",
    "cryptopay_waiting": "Payment is not confirmed yet. Status: {status}.",
    "cryptopay_canceled": "Invoice is not paid. Status: {status}.",
    "cryptopay_pay_button": "🪙 Crypto Pay",
    "cryptopay_check_button": "🔄 Check payment",
    "cryptopay_paid_notify": "✅ Crypto Pay payment confirmed. Credited {credits} {credits, plural, one {credit} other {credits}}.",
...
BASE_ES.update(
    {
        ...
        "output_empty_hint": "Tus resultados apareceran aqui ✨\nDescribe lo que quieres crear y pulsa Generar.",
        "result_view_grid": "Cuadricula",
        "result_view_carousel": "Carrusel",
        "result_download": "Descargar",
        "result_regenerate": "Regenerar",
        "result_regenerate_this": "Regenerar esta",
        "result_edit_prompt": "Editar prompt",
        "result_edit_ai": "Editar con AI",
        "result_edit_with_title": "Editar con:",
        "result_edit_with_no_models": "No hay modelos con referencias.",
        "result_favorite_add": "Guardar en favoritos",
        "result_favorite_remove": "Quitar favorito",
        "result_reference_added": "Imagen agregada como referencia. Ahora puedes modificar el prompt y regenerar.",
        "result_reference_limit": "Se alcanzo el maximo de imagenes de referencia.",
        "result_reference_failed": "No se pudo agregar la imagen como referencia.",
        "result_favorite_saved": "Guardado en favoritos.",
        "result_favorite_removed": "Eliminado de favoritos.",
        "download": "Descargar",
        "delete": "Eliminar",
        ...
        "prompt_helper_button": "Plantillas",
        "prompt_helper_title": "Plantillas de prompt",
        "prompt_helper_empty": "No hay plantillas disponibles.",
        "prompt_history_button": "Historial",
        "prompt_history_title": "Prompts recientes",
        "prompt_history_empty": "El historial de prompts esta vacio.",
        "prompt_history_remove": "Eliminar del historial",
        "prompt_length_hint": "Caracteres: {count}/{max}",
        "prompt_too_long": "El prompt es demasiado largo. Maximo: {max} caracteres.",
        "brain_improve_button": "Mejorar Prompt (costo: {cost})",
        "brain_improve_loading": "Mejorando tu prompt...",
        "brain_restore_original": "↩ Restaurar original",
        "brain_improve_success": "Prompt mejorado.",
        "brain_unavailable": "AI Brain no esta disponible ahora.",
        "brain_daily_limit_reached": "Se alcanzo el limite diario de mejoras.",
        "brain_not_enough_credits": "No hay creditos suficientes para mejorar el prompt.",
        "brain_rate_limited": "Demasiadas solicitudes. Intenta de nuevo en unos segundos.",
        "brain_failed": "No se pudo mejorar el prompt.",
        "brain_pack_used": "Se uso una mejora de tu paquete.",
        "brain_credits_used": "Se cobraron {credits} creditos por la mejora.",
        "brain_pack_buy_button": "Comprar paquete: {size} mejoras por {price} creditos",
        "brain_pack_remaining": "En paquete: {count}",
        "brain_pack_buying": "Comprando paquete de mejoras...",
        "brain_pack_buy_success": "Paquete comprado: +{size} mejoras.",
        "brain_pack_buy_failed": "No se pudo comprar el paquete de mejoras.",
        "prompt_template_logo_title": "Logo / marca",
        "prompt_template_logo_text": "Logo o marca para [nombre de marca], estilo vector minimalista, lineas limpias, contraste fuerte, fondo transparente",
        "prompt_template_social_title": "Post para redes",
        "prompt_template_social_text": "Post para redes sobre [tema], composicion llamativa, tipografia fuerte, acentos vibrantes, formato 4:5",
        "prompt_template_cinematic_title": "Escena cinematica",
        "prompt_template_cinematic_text": "Escena cinematica con [sujeto], iluminacion dramatica, niebla volumetrica, ultra detallada, estilo pelicula, 4K",
        "prompt_template_product_title": "Mockup de producto",
        "prompt_template_product_text": "Mockup premium para [producto], iluminacion de estudio, sombras suaves, materiales realistas, estilo comercial",
        "prompt_template_icon_title": "Icono minimalista",
        "prompt_template_icon_text": "Icono minimalista para [idea de app], diseno plano, bordes definidos, composicion centrada, estilo vectorial",
        "prompt_template_portrait_title": "Retrato fotorrealista",
        "prompt_template_portrait_text": "Retrato fotorrealista de [sujeto], iluminacion cinematica, ultra detallado, 4K, fotografia profesional",
        ...
        "miniapp_auth_in_progress": "Iniciando sesion mediante Telegram Mini App...",
        "miniapp_auth_failed": "Error de inicio de sesion automatico. Abre la aplicacion de nuevo desde el bot.",
        ...
        "quote_cost": "Costo: {total} creditos",
        "quote_info_title": "Desglose del costo",
        "quote_info": "ℹ️",
        "quote_breakdown_base": "Base",
        "quote_breakdown_outputs": "Resultados (x{count})",
        "quote_breakdown_discount": "Descuento",
        "quote_breakdown_total": "Total",
        "quote_breakdown_fallback": "Desglose no disponible.",
        "quote_insufficient": "No tienes creditos suficientes. Recarga tu saldo.",
        "confirm_title": "Confirmacion de generacion",
        "confirm_message": "Esta generacion costara {total} creditos. Continuar?",
        "confirm_cancel": "Cancelar",
        "confirm_continue": "Confirmar",
        "confirm_dont_show_again": "No mostrar de nuevo",
        "confirm_skip_toggle": "Omitir confirmacion antes de generar",
        ...
        "payment_topup_crypto": "🪙 Comprar con Crypto Pay",
        ...
        "cryptopay_choose": "🪙 Elige un paquete para pagar con Crypto Pay:",
        "cryptopay_unavailable": "Crypto Pay no esta disponible ahora. Revisa la configuracion de integracion.",
        "cryptopay_create_failed": "No se pudo crear la factura de Crypto Pay.",
        "cryptopay_status_failed": "No se pudo verificar el estado del pago de Crypto Pay.",
        "cryptopay_invoice_created": "Factura creada: {amount} {currency}. Abre el pago y pulsa «Verificar pago» despues de pagar.",
        "cryptopay_waiting": "El pago aun no esta confirmado. Estado: {status}.",
        "cryptopay_canceled": "La factura no esta pagada. Estado: {status}.",
        "cryptopay_pay_button": "🪙 Crypto Pay",
        "cryptopay_check_button": "🔄 Verificar pago",
        "cryptopay_paid_notify": "✅ Pago de Crypto Pay confirmado. Se acreditaron {credits} {credits, plural, one {credito} other {creditos}}.",
        "settings_title": "⚙️ Ajustes",
        "settings_language": "🌐 Idioma",
        "settings_back": "⬅️ Volver",
        "settings_back_to_main": "🏠 Menu principal",
        "settings_lang_prompt": "Elige el idioma de la interfaz:",
        "settings_lang_prompt_first": "Elige tu idioma preferido:",
        "settings_lang_saved": "Idioma guardado: {language}",
        "terms_intro": "Antes de usar el bot, debes aceptar los terminos:",
        "terms_link": "📄 <a href=\"{link}\">Leer terminos</a>",
        "terms_question": "¿Aceptas estos terminos?",
        "terms_accept_btn": "✅ Acepto",
        "terms_decline_btn": "❌ No acepto",
        "terms_read_btn": "📄 Leer terminos",
        "terms_declined_blocked": "El acceso al bot esta bloqueado hasta aceptar los terminos.",
        "terms_blocked_notice": "No se puede usar el bot sin aceptar los terminos.",
        "terms_blocked_alert": "No se puede usar el bot sin aceptar los terminos.",
