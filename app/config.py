...
class Settings(BaseSettings):
    ...
    walletpay_api_key: str = Field('', alias='WALLETPAY_API_KEY')
    walletpay_base_url: str = Field('https://pay.wallet.tg', alias='WALLETPAY_BASE_URL')
    walletpay_currency: str = Field('USD', alias='WALLETPAY_CURRENCY')
    walletpay_timeout_seconds: int = Field(10800, alias='WALLETPAY_TIMEOUT_SECONDS')
    walletpay_return_url: str = Field('', alias='WALLETPAY_RETURN_URL')
    walletpay_fail_return_url: str = Field('', alias='WALLETPAY_FAIL_RETURN_URL')
