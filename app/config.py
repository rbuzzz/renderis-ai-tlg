...
class Settings(BaseSettings):
    ...
    kie_webhook_hmac_key: str = Field('', alias='KIE_WEBHOOK_HMAC_KEY')
    ...
    cryptopay_base_url: str = Field('https://pay.crypt.bot', alias='CRYPTOPAY_BASE_URL')
    cryptopay_fiat: str = Field('USD', alias='CRYPTOPAY_FIAT')
    cryptopay_accepted_assets: str = Field('', alias='CRYPTOPAY_ACCEPTED_ASSETS')
    cryptopay_expires_in: int = Field(10800, alias='CRYPTOPAY_EXPIRES_IN')
