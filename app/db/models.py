...
class User(Base):
    ...
    balance_credits: Mapped[Decimal] = mapped_column(Numeric(12, 3), default=Decimal("0"))
...
class CreditLedger(Base):
    ...
    delta_credits: Mapped[Decimal] = mapped_column(Numeric(12, 3))
...
class Price(Base):
    ...
    price_credits: Mapped[Decimal] = mapped_column(Numeric(12, 3))
...
class Generation(Base):
    ...
    total_cost_credits: Mapped[Decimal] = mapped_column(Numeric(12, 3))
    discount_pct: Mapped[int] = mapped_column(Integer, default=0)
    final_cost_credits: Mapped[Decimal] = mapped_column(Numeric(12, 3))
    status: Mapped[str] = mapped_column(String(16))
    created_at: Mapped[datetime] = mapped_column(DateTime(timezone=True))
    updated_at: Mapped[datetime] = mapped_column(DateTime(timezone=True))
